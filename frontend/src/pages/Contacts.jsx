...
const Contacts = () => {
    ...
    const syncContacts = async () => {
        ...
        try {
            ...
            const res = await axios.get('http://localhost:5000/api/auth/users/search?query=', config);
    ...
    const fetchContacts = async () => {
        try {
            const res = await axios.get(`http://localhost:5000/api/auth/users/search?query=${search}`, config);
            setContacts(res.data);
